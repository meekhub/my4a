CREATE OR REPLACE PROCEDURE P_DM_ZQ_CHANNEL_HUAXIAO_M(V_ACCT_MONTH VARCHAR2,
...
BEGIN
 ...
 GROUP BY AREA_NO, CITY_NO, HUAXIAO_TYPE, HUAXIAO_NO, HUAXIAO_NAME,CHANNEL_NO,CHANNEL_NO_DESC;
 COMMIT;
    END LOOP;
