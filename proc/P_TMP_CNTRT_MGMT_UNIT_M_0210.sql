CREATE OR REPLACE PROCEDURE P_TMP_CNTRT_MGMT_UNIT_M(V_MONTH   VARCHAR2,
  ...
  IF V_COUNT1 >= 0 THEN
    ...
    INTO ALLDM.BWT_CNTRT_MGMT_UNIT_M
      SELECT V_MONTH,
             ...
             CASE
               WHEN HUAXIAO_TYPE IN ('01','02','03','04','05','06','07') THEN
                '20'
       ...
       AND A.HUAXIAO_TYPE IN ('01','02','03','04','05','06','07','09')
