CREATE OR REPLACE PROCEDURE P_TMP_V_CHANNEL_INFO_M(V_ACCT_MONTH VARCHAR2,
...
BEGIN
  ...
  IF V_COUNT = 1 THEN
    ...
    --删除当月数据
    DELETE FROM ALLDM.TMP_V_CHANNEL_INFO_M WHERE ACCT_MONTH = V_ACCT_MONTH;
    COMMIT;
    
  INSERT INTO TMP_V_CHANNEL_INFO_M
    SELECT V_ACCT_MONTH,
           AREA_NO,
           CITY_NO,
           HUAXIAO_TYPE,
