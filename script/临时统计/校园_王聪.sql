select * from dim.dim_huaxiao_info a where a.huaxiao_type='07';
select * from dim.dim_channel_huaxiao a where a.huaxiao_type='07';

--沉淀基础数据
create table tmp_majh_0304_gx_01 as
select '201802' ACCT_MONTH,
  ...
  from (SELECT A.AREA_NO,
       ...
       (select * from dim.dim_channel_huaxiao a where a.huaxiao_type='07')b 
   where  a.group_no=b.channel_no(+);
...
count(case when a.tele_type_name='固话' and a.is_new='1' then a.user_no end)acct_cnt_new
 from  tmp_majh_0304_gx_01 a, dim.dim_huaxiao_info b,dim.dim_area_no c,dim.dim_city_no d
...
--收入
sum(a.total_fee+a.total_fee_ocs) total_fee_all
 from  tmp_majh_0304_gx_01 a, dim.dim_huaxiao_info b,dim.dim_area_no c 
where a.huaxiao_no=b.huaxiao_no 
and b.area_no=c.area_no 
...
--收入
sum(a.total_fee+a.total_fee_ocs) total_fee_all
 from  tmp_majh_0304_gx_01 a, dim.dim_huaxiao_info b,dim.dim_area_no c，tmp_majh_sk_01 d
where a.huaxiao_no=b.huaxiao_no
and b.area_no=c.area_no 
...
--收入
sum(a.total_fee+a.total_fee_ocs) total_fee_all
 from  tmp_majh_0304_gx_01 a, dim.dim_huaxiao_info b,dim.dim_area_no c，tmp_majh_0304_yw_03 d
where a.huaxiao_no=b.huaxiao_no
and b.area_no=c.area_no 
and a.user_no=d.user_no 
and d.huaxiao_no is not null
