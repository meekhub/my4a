...
select 
 c.area_desc,
 count(distinct a.device_no),
 count(distinct case when substr(b.REG_DATE,1,6)='201806'  then a.device_no end)a,
 count(distinct case when substr(b2.REG_DATE,1,6)='201807' and b.TERMINAL_CODE is null then a.device_no end)b
  from (select * from  tmp_majh_0328_02 where substr(begin_date,1,6)='201806') a,
 (select * from tmp_majh_0409_01 where substr(REG_DATE,1,6)='201806') b,
 (select * from tmp_majh_0409_01 where substr(REG_DATE,1,6)='201807') b2,
 dim.dim_area_no c
 where a.device_no=b.TERMINAL_CODE(+)    
