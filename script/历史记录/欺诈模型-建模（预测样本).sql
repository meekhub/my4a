...
select device_number,decode(b.is_ocs,'是','1','0') is_ocs from DW_V_USER_BASE_INFO_USER b where 
acct_month='201705' and is_onnet='是' and tele_type='2'
...
SELECT DEVICE_NUMBER,
       ...
       (TOTAL_FEE + TOTAL_FEE_OCS)TOTAL_FEE, --出账收入
       CASE
       ...
       INNET_MONTH, -- 入网时长
       decode(IS_OCS,'是','1','0')is_ocs, --是否预付费卡
       channel_no, --终端编码
       terminal_corp,--终端厂商
       terminal_model, --终端型号
       user_dinner --套餐
