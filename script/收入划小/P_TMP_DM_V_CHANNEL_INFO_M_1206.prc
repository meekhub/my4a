CREATE OR REPLACE PROCEDURE P_TMP_DM_V_CHANNEL_INFO_M(V_ACCT_MONTH VARCHAR2,
                        ...
                        SELECT T.AREA_NO,
                          ...
                          FROM (SELECT SUM(CASE
                                 ...
                                 WHERE A.ACCT_MONTH = V_ACCT_MONTH
                                   AND AREA_NO = C1.AREA_NO
                                  -- AND A.IS_VALID = '1'
                                   and ((a.xiaoqu_no is not null and a.tele_type = '2') or a.tele_type <> '2')
                                   AND A.IS_HUAXIAO_03 = '1'
                                 GROUP BY A.HUAXIAO_NO_03,
                                          A.XIAOQU_NO,
                                          A.XIAOQU_NAME
