...
create table tmp_majh_yw_hx_qhdhs
(
...
--整理
select a.* from tmp_majh_yw_hx_qhdhs a,dim.dim_area_no b,dim.dim_city_no c
...
b.area_no,c.city_no,d.city_no_new,a.huaxiao_name,a.huaxiao_type_name,a.huaxiao_level
 from dim.tmp_majh_yw_hx_qhdhs a,dim.dim_area_no b,dim.dim_city_no c,
